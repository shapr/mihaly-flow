{
  ...
  in
    utils.eachDefaultSystem (system: let
      ...
      mihaly-flow = craneLib.buildPackage (craneCommon
        // {
    ...
    in {
      checks = {
        ...
        mihaly-flow-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        mihaly-flow-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        mihaly-flow-audit = craneLib.cargoAudit {
